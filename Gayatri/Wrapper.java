...
public class Wrapper {
	...
	public void send_rpc(JSONObject obj) throws IOException { 
		System.out.println("about to send back data");
		Socket socket = new Socket("localhost", 40000);
		System.out.println("created socket");
		DataOutputStream out = new DataOutputStream(socket.getOutputStream());
		System.out.println("created output datastream");
		String jsonToReturn = obj.toString();
		System.out.println("about to write " + jsonToReturn);
		out.writeBytes(jsonToReturn);
	...
	public SUser listen_rpc() throws IOException {
		...
		int alarm = Integer.parseInt(obj.getString("alarm_time"));
		String key = did + "/" + sid;
