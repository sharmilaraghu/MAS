...
import com.example.android.smartalarm.AlarmContract.Alarm;

public class AlarmDBHelper extends SQLiteOpenHelper {

    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME = "alarmclockNew.db";
    ...
    private static final String SQL_CREATE_ALARM = "CREATE TABLE " + Alarm.TABLE_NAME + " (" +
            ...
            Alarm.COLUMN_NAME_SMART_ENABLED + " BOOLEAN" + " )";
    ...
    private AlarmModel populateModel(Cursor c) {
        ...
        model.isSmartEnabled = c.getInt(c.getColumnIndex(Alarm.COLUMN_NAME_SMART_ENABLED)) == 0 ? false : true;
    ...
    private ContentValues populateContent(AlarmModel model) {
        ...
        values.put(Alarm.COLUMN_NAME_SMART_ENABLED, model.isSmartEnabled);
        Log.d("SmartEnabledValue",""+model.isSmartEnabled);
    ...
    public int maxAlarmId()
    {

        SQLiteDatabase db = this.getReadableDatabase();
        int maxId=0;
        String select = "SELECT MAX(Alarm._ID) FROM " + Alarm.TABLE_NAME;
